...
public class SubjectCourseCreatedHandler : IKafkaConsumerHandler<SubjectCourseCreatedKey, SubjectCourseCreatedValue>
{
    ...
    public async ValueTask HandleAsync(
        IEnumerable<IKafkaConsumerMessage<SubjectCourseCreatedKey, SubjectCourseCreatedValue>> messages,
